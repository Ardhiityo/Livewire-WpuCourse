<div class="flex md:flex-row flex-col justify-center items-start gap-10">
    ...
    <div class="flex w-1/2 flex-col justify-center py-12">
        ...
        <form class="w-md mx-auto mt-10" method="POST" wire:submit='search' action="#">
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search"
                    ...
                    placeholder="Search User Lists..." wire:model.live='keyword' name="keyword" />
                <button type="submit"
            ...
            @foreach ($users as $user)
                <li class="flex justify-between gap-x-6 py-5">
                    <div class="flex min-w-0 gap-x-4">
                        <img src="{{ asset($user->avatar ? Storage::url($user->avatar) : 'guest.png') }}"
